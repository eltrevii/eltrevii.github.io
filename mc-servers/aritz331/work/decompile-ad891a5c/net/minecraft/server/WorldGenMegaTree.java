...
public class WorldGenMegaTree extends WorldGenMegaTreeAbstract<WorldGenFeatureEmptyConfiguration> {
    ...
    public boolean a(Set<BlockPosition> set, VirtualLevelWritable virtuallevelwritable, Random random, BlockPosition blockposition) {
        ...
        if (!this.a(virtuallevelwritable, blockposition, i)) {
            ...
            this.a(virtuallevelwritable, blockposition.getX(), blockposition.getZ(), blockposition.getY() + i, 0, random);

            for (int j = 0; j < i; ++j) {
                if (g(virtuallevelwritable, blockposition.up(j))) {
                    this.a(set, (IWorldWriter) virtuallevelwritable, blockposition.up(j), this.aS);
                }

                if (j < i - 1) {
                    if (g(virtuallevelwritable, blockposition.b(1, j, 0))) {
                        this.a(set, (IWorldWriter) virtuallevelwritable, blockposition.b(1, j, 0), this.aS);
                    }

                    if (g(virtuallevelwritable, blockposition.b(1, j, 1))) {
                        this.a(set, (IWorldWriter) virtuallevelwritable, blockposition.b(1, j, 1), this.aS);
                    }

                    if (g(virtuallevelwritable, blockposition.b(0, j, 1))) {
                        this.a(set, (IWorldWriter) virtuallevelwritable, blockposition.b(0, j, 1), this.aS);
                    }
                }
            }
    ...
    private void a(VirtualLevelWritable virtuallevelwritable, int i, int j, int k, int l, Random random) {
        ...
        for (int k1 = k - i1; k1 <= k; ++k1) {
            ...
            this.b(virtuallevelwritable, new BlockPosition(i, k1, j), i2 + (l1 > 0 && i2 == j1 && (k1 & 1) == 0 ? 1 : 0));
            j1 = i2;
        }
