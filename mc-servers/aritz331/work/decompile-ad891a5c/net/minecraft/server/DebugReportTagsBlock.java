...
public class DebugReportTagsBlock extends DebugReportTags<Block> {
    ...
    protected void b() {
        ...
        this.a(TagsBlock.WOODEN_FENCES).a((Object[])(Blocks.OAK_FENCE, Blocks.ACACIA_FENCE, Blocks.DARK_OAK_FENCE, Blocks.SPRUCE_FENCE, Blocks.BIRCH_FENCE, Blocks.JUNGLE_FENCE));
        ...
        this.a(TagsBlock.SMALL_FLOWERS).a((Object[])(Blocks.DANDELION, Blocks.POPPY, Blocks.BLUE_ORCHID, Blocks.ALLIUM, Blocks.AZURE_BLUET, Blocks.RED_TULIP, Blocks.ORANGE_TULIP, Blocks.WHITE_TULIP, Blocks.PINK_TULIP, Blocks.OXEYE_DAISY, Blocks.CORNFLOWER, Blocks.LILY_OF_THE_VALLEY, Blocks.WITHER_ROSE));
        this.a(TagsBlock.ENDERMAN_HOLDABLE).a(TagsBlock.SMALL_FLOWERS).a((Object[])(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.SAND, Blocks.RED_SAND, Blocks.GRAVEL, Blocks.BROWN_MUSHROOM, Blocks.RED_MUSHROOM, Blocks.TNT, Blocks.CACTUS, Blocks.CLAY, Blocks.PUMPKIN, Blocks.CARVED_PUMPKIN, Blocks.MELON, Blocks.MYCELIUM, Blocks.NETHERRACK));
        ...
        this.a(TagsBlock.DIRT_LIKE).a((Object)Blocks.DIRT).a((Object)Blocks.GRASS_BLOCK).a((Object)Blocks.PODZOL).a((Object)Blocks.COARSE_DIRT).a((Object)Blocks.MYCELIUM);
        this.a(TagsBlock.BAMBOO_PLANTABLE_ON).a((Object)Blocks.BAMBOO).a((Object)Blocks.BAMBOO_SAPLING).a((Object)Blocks.GRAVEL).a(TagsBlock.SAND).a(TagsBlock.DIRT_LIKE);
        this.a(TagsBlock.STANDING_SIGNS).a((Object[])(Blocks.OAK_SIGN, Blocks.SPRUCE_SIGN, Blocks.BIRCH_SIGN, Blocks.ACACIA_SIGN, Blocks.JUNGLE_SIGN, Blocks.DARK_OAK_SIGN));
        this.a(TagsBlock.WALL_SIGNS).a((Object[])(Blocks.OAK_WALL_SIGN, Blocks.SPRUCE_WALL_SIGN, Blocks.BIRCH_WALL_SIGN, Blocks.ACACIA_WALL_SIGN, Blocks.JUNGLE_WALL_SIGN, Blocks.DARK_OAK_WALL_SIGN));
        this.a(TagsBlock.SIGNS).a(TagsBlock.STANDING_SIGNS).a(TagsBlock.WALL_SIGNS);
        this.a(TagsBlock.BEDS).a((Object[])(Blocks.RED_BED, Blocks.BLACK_BED, Blocks.BLUE_BED, Blocks.BROWN_BED, Blocks.CYAN_BED, Blocks.GRAY_BED, Blocks.GREEN_BED, Blocks.LIGHT_BLUE_BED, Blocks.LIGHT_GRAY_BED, Blocks.LIME_BED, Blocks.MAGENTA_BED, Blocks.ORANGE_BED, Blocks.PINK_BED, Blocks.PURPLE_BED, Blocks.WHITE_BED, Blocks.YELLOW_BED));
        this.a(TagsBlock.FENCES).a(TagsBlock.WOODEN_FENCES).a((Object)Blocks.NETHER_BRICK_FENCE);
        this.a(TagsBlock.DRAGON_IMMUNE).a((Object[])(Blocks.BARRIER, Blocks.BEDROCK, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME, Blocks.END_GATEWAY, Blocks.COMMAND_BLOCK, Blocks.REPEATING_COMMAND_BLOCK, Blocks.CHAIN_COMMAND_BLOCK, Blocks.STRUCTURE_BLOCK, Blocks.JIGSAW, Blocks.MOVING_PISTON, Blocks.OBSIDIAN, Blocks.END_STONE, Blocks.IRON_BARS));
        this.a(TagsBlock.WITHER_IMMUNE).a((Object[])(Blocks.BARRIER, Blocks.BEDROCK, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME, Blocks.END_GATEWAY, Blocks.COMMAND_BLOCK, Blocks.REPEATING_COMMAND_BLOCK, Blocks.CHAIN_COMMAND_BLOCK, Blocks.STRUCTURE_BLOCK, Blocks.JIGSAW, Blocks.MOVING_PISTON));
    }
